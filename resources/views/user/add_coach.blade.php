    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-cyan-600 via-sky-600 to-blue-600 bg-clip-text text-transparent mb-4">
                Créer un nouveau profil d'entraîneur
            </h1>
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                Remplissez les informations personnelles et la planification de disponibilité de l'entraîneur
            </p>
        </div>

        <!-- Main Form Container -->
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 mb-8">
            <form action="{{ route('user.store') }}" onsubmit="return coachUpdatePlanning()" enctype="multipart/form-data" method="POST">
        @csrf
                <!-- Form Grid -->
            ...
            <!-- Left Column -->
                    <div class="space-y-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-input" id="tel" name="tel" required>
                </div>
                        <div class="form-group">
                            <label for="email" class="form-label">Adresse e-mail</label>
                            <input type="email" class="form-input @error('email') border-red-500 @enderror" id="email" name="email" required>
                    @error('email')
                    ...
                    @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-input @error('password') border-red-500 @enderror" id="password" name="password" required>
                    ...
                    <div class="space-y-6">
                        <div class="form-group">
                            ...
                            <select class="form-select" id="specialist" name="speciality_id" required>
                                <option value="" disabled selected>Choisir une spécialisation</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-center">
                                ...
                                <div id="image-preview" class="mt-4 hidden">
                                    <img src="#" alt="Aperçu de l'image" id="image-preview-img" class="w-20 h-20 rounded-full object-cover border-4 border-cyan-200 shadow-lg">
                                </div>
                    </div>
                </div>
            </div>
        ...
        <input type="hidden" id="planning" name="planning">
                <div class="text-center">
                    <button type="submit" class="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-sky-600 text-white px-8 py-4 rounded-2xl font-semibold hover:from-cyan-600 hover:to-sky-700 transform hover:-translate-y-1 transition-all duration-200 shadow-lg hover:shadow-2xl">
                        <i class="fas fa-save"></i> Créer le profil d'entraîneur
        </button>
                </div>
    </form>
        </div>
