                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mt-4 d-none" id="manualPatient">
                                ...
                                <!-- <small class="text-muted">Tous les patients en fonction de la spécialité</small> -->
                                <!-- <select name="" id="allPatientsSelect" class="form-control text-black">
...
<!-- <script>
        ...
        let autoGeneratedPatients = null ;
        let warningMsg = '';
        ...
        document.getElementById('allPatientsSelect').innerHTML = '<option value="">Select a patient</option>';
        document.querySelector('#errorMsg').innerHTML = '';
        document.querySelector('#errorMsg').classList.add('d-none')
    }    
    function openChangeModal(specialityId, date, startTime, endTime, patient_id ,event) {
        ...
        // Call your endpoint to fetch available patients matching these criteria.
        ...
        .then(response => {
            if (!response.ok) throw new Error("Failed to load available patients");
    ...
    function updateSuggestedAppointment() {
        ...
        // const select = document.getElementById('availablePatientsSelect');
        // const selectedPatient = select.options[select.selectedIndex];

        // manualy 
        const allPatientsSelect = document.querySelector('#allPatientsSelect');
        const selectedPatientManually = allPatientsSelect.options[allPatientsSelect.selectedIndex];
    ...
    function selectRandomAutoPatient() {
        ...
        // Select a random patient from the autoGeneratedPatients array
        ...
        // Display the chosen patient in the input field
        ...
        document.querySelector('#autogeneratedPatient').classList.remove('d-none');
    ...
    function manualPatient() {
        ...
        document.querySelector('#autogeneratedPatient').classList.add('d-none');
        document.querySelector('#errorMsg').classList.add('d-none');
        document.querySelector('#errorMsg').innerHTML = '';

        // const all_patient_select = document.getElementById('allPatientsSelect');

        // all_patient_select.innerHTML = '<option value="">Select a patient</option>';  
        ...
        //     all_patient_select.appendChild(option);
        // });
    }
...
<script>
   ...
   // chacnge patient modal
    ...
    function manualPatient() {
        ...
        // all_patient_select.innerHTML = '<option value="">Sélectionnez un patient</option>';  
