                    ...
                    <div class="info-column">
                        ...
                        <div class="info-row">
                            ...
                            @elseif ($appointment->patient->gender == "F")
                               <span>Féminin <i class="bi bi-gender-female"></i></span> 
                            @endif
                        </div>
                        <div class="info-row">
                            <label>Âge:</label>
                ...
                <div class="existing-report">
                    ...
                    <div class="file-actions">
                        <a href="{{route('coach-appointments.downloadReport', $appointment->id)  }}" 
                           class="btn-download" title="Télécharger">
                        ...
                        <form action="{{  route('coach-appointments.deleteReport', $appointment->id)}}" 
                            ...
                            @csrf
                            @method('DELETE')
                            <button type="button" class="btn-delete" onclick="confirmDelete(this)" title="Supprimer">
